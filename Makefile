# This Makefile is for the App::cpanminus extension to perl.
#
...
#     ABSTRACT => q[get, unpack, build and install modules from CPAN]
#     AUTHOR => [q[- Tatsuhiko Miyagawa]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     DISTNAME => q[App-cpanminus]
#     EXE_FILES => [q[bin/cpanm]]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.008001]
#     NAME => q[App::cpanminus]
...
TO_INST_PM = lib/App/cpanminus.pm \
	lib/App/cpanminus/fatscript.pm
...
DISTVNAME = App-cpanminus-1.7040
...
cpanminus.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"App::cpanminus\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) -u \
	  bin/cpanm $(INST_MAN1DIR)\cpanm.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/App/cpanminus.pm $(INST_MAN3DIR)\App.cpanminus.$(MAN3EXT) \
	  lib/App/cpanminus/fatscript.pm $(INST_MAN3DIR)\App.cpanminus.fatscript.$(MAN3EXT) 
...
$(INST_SCRIPT)\cpanm : bin/cpanm $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\cpanm
	$(CP) bin/cpanm $(INST_SCRIPT)\cpanm
	$(FIXIN) $(INST_SCRIPT)\cpanm
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\cpanm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'get, unpack, build and install modules from CPAN'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: App-cpanminus" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "version: '1.7040'" >> META_new.yml
	$(NOECHO) $(ECHO) "x_serialization_backend: 'CPAN::Meta::YAML version 0.018'" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) {{ > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"get, unpack, build and install modules from CPAN\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"App-cpanminus\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   \"version\" : \"1.7040\"," >> META_new.json
...
MAP_TARGET    = perl
FULLPERL      = "C:\Perl64\bin\perl.exe"
MAP_PERLINC   = "-Iblib\arch" "-Iblib\lib" "-IC:\Perl64\lib" "-IC:\Perl64\lib"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"App-cpanminus\" VERSION=\"1.7040\">" > App-cpanminus.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>get, unpack, build and install modules from CPAN</ABSTRACT>" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>- Tatsuhiko Miyagawa</AUTHOR>" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "        <PERLCORE VERSION=\"5,008001,0,0\" />" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.24\" />" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> App-cpanminus.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> App-cpanminus.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/App/cpanminus.pm blib\lib\App\cpanminus.pm \
	  lib/App/cpanminus/fatscript.pm blib\lib\App\cpanminus\fatscript.pm 
